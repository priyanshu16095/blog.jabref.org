...
Here, the second entry is missing the journaltitle field, which is required for an article. Running the Check Consistency tool will highlight this issue as shown:

![Consistency check results](<../img/consistencycheck_result.png>)
